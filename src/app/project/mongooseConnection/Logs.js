    ...
    <div className="font-mono text-lg text-gray-300 tracking-wide">
      <SectionHeader>
        <div className="w-full flex flex-row justify-between items-baseline font-mono tracking-widest px-2">
          ...
          <h3 className="text-base text-gray-400">16 July 2025</h3>
        </div>
      </SectionHeader>
      <ul className="list-disc pl-8 space-y-4 font-mono text-lg text-gray-300 tracking-wide leading-relaxed">
        ...
        <li>
          <strong className="text-green-400">Added</strong>: Systems for loading mongoDB URI, create connection, get connection and closing a connection.
        </li>
      </ul>
      <SectionHeader>
        <div className="w-full flex flex-row justify-between items-baseline font-mono tracking-widest px-2">
          {/* Version: Bold, white, and larger */}
          <h2 className="text-xl font-bold text-white">v1.1.0 - TypeScript Support</h2>

          {/* Date: Dimmer color and slightly smaller text */}
          <h3 className="text-base text-gray-400">16 September 2025</h3>
        </div>
      </SectionHeader>
      <ul className="list-disc pl-8 space-y-4 font-mono text-lg text-gray-300 tracking-wide leading-relaxed">
        <li>
          <strong className="text-green-400">Added</strong>: Support file declarations for TypeScript.
        </li>
      </ul>
      <SectionHeader>
        <div className="w-full flex flex-row justify-between items-baseline font-mono tracking-widest px-2">
          {/* Version: Bold, white, and larger */}
          <h2 className="text-xl font-bold text-white">v1.1.1 & v1.1.2 - Bug Fix</h2>
