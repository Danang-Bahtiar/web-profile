export default {
  ...
  vault: {
    starChips: {type: Number, default: 1000},
    voltixGems: {type: Number, default: 0}
  },
  guildQuest: { type: [String], default: [] },
  spawnEligibility: {type: Boolean, default: false},
  status: {type: String, enum: ['public', 'private'], default: "public"},
  guildPassLevel: {type: Number, default: 1},
  guildPassExp: {type: Number, default: 0, max: 2000},
  guildPassType: {type: String, enum: ['basic', 'premium'], default: "basic"},
}, {timestamps: true});`}
          </code>
        </pre>
      </div>
